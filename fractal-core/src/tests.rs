...
use crate::{
    ...
    registry::{
        ...
        take_last_species_run_artifact, training_progress_interval, ComputeBackend,
...
fn run_species_failure_snapshot_preserves_diagnostics_tail() {
    ...
    let result = run_species_with_batches(
        ...
        None,
        device,
        FailingRule::<CpuTrainBackend>::new(16, 1),
        batches,
    );
...
fn tournament_parallel_panic_preserves_live_failure_snapshot_state() {
    ...
    assert!(record
        ...
        .contains("synthetic panic during forward"));
...
fn panic_training_species_runner(
    ...
    run_species_with_factory_candle(
        ...
        context,
        cpu_device(),
        |config, _device| PanickingRule::<CpuTrainBackend>::new(config.dim, 0),
    )
}
