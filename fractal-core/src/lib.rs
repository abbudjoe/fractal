...
pub use v2::{
    ...
    FractalV2Model, FractalV2ModelShape, FractalV2RetrievalStepOutput, FractalV2RetrievalTrace,
    FractalV2State, FractalV2StateLayout, FractalV2StateRecord, FractalV2StateShape,
    HeadRouteTrace, LeafSummarizer, LeafSummarizerOutput, LeafSummarizerShape, LeafSummaryStore,
    ...
    RetrievalPolicy, RootActivationStats, RoutingHistogramBin, SealedLeafMaterialization,
    TokenSpan, TreeLevelStore, TreeLevelStoreRecord, TreeLevelStoreShape, TreeMergeCell,
    TreeMergeCellShape, TreeMergeOutput, TreeNodeAddress, TreeNodeBatch, TreeSummaryDiagnostics,
    TreeSummaryState, TreeSummaryStateRecord, TreeSummaryStateShape,
};
