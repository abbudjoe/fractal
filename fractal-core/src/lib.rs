...
pub use hybrid_attention::{
    ...
    build_attention_only_recurrent_scale_proxy_model,
    build_attention_only_recurrent_graph_of_experts_model, build_primitive_hybrid_attention_model,
    build_attention_only_scale_proxy_model,
    build_reference_ssm_graph_of_experts_model, build_rust_mamba3_reference_hybrid_attention_model,
    ...
    minimal_recurrent_router_experiment_matrix, phase1_hybrid_attention_baseline_matrix,
    ...
    AttentionOnlyRecurrentGraphOfExpertsModel,
    AttentionOnlyRecurrentScaleProxyModel, AttentionOnlyRecurrentScaleProxyVariantSpec,
    AttentionOnlyRecurrentGraphOfExpertsVariantSpec, GraphOfExpertsBackboneKind,
    ...
    RustMamba3ReferenceHybridAttentionModel, RustMamba3RopeFraction, VirtualNodeRecurrentRouter,
    AttentionOnlyScaleProxyModel, AttentionOnlyScaleProxyVariantSpec,
    DEFAULT_RECURRENT_ROUTER_ROUND_COUNT, DEFAULT_RECURRENT_ROUTER_STATE_WIDTH,
    DEFAULT_SCALE_PROXY_EXPERT_LAYER_INDEX, GOE_CHANNEL_COUNT,
    MAX_RECURRENT_ROUTER_ROUND_COUNT, PATH1_PHASE1_LOCAL_WINDOW_SIZE,
    RECURRENT_DREEGMOR_CHANNEL_COUNT, SCALE_PROXY_CHANNEL_COUNT, ScaleProxyRoutingProbe,
};
