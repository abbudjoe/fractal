...
| p1_fractal_hybrid_v1                  | p1                 | static squaring             | Promising               | 0.61        | 1.24      | 1.73       | 0.74  | Intermediate-stress rerun improved fitness and ARC, but raw stability stayed above the `0.80` co-leader threshold |
| logistic_chaotic_map_v1               | logistic           | static r-clamp + residual   | Upper cohort candidate  | 0.46        | 1.18      | 3.49       | 0.44  | Minimal-baseline rerun improved fitness above the `0.45` promotion gate; promote to the upper cohort |
...
| Variant Name                          | Base Primitive     | Lever Type                  | Status                 | Last Fitness | Stability | Perplexity | ARC   | Notes / Next Action |
|---------------------------------------|--------------------|-----------------------------|------------------------|--------------|-----------|------------|-------|---------------------|
| ifs_dyn-radius-depth_v1               | ifs                | dynamic radius by depth     | Runtime-bounded failure | 0.38         | 0.21      | 10.05      | 0.21  | Bounded CUDA minimal-stress rerun hit the 20-minute timeout with no completed metrics; do not promote |
...
| generalized_mobius_dyn-jitter-norm_v2 | generalized_mobius | dynamic jitter by norm      | Failed minimal stress  | 0.10         | NaN       | NaN        | 0.00  | Stronger denominator-control rerun still produced NaN stability/perplexity; keep out of promotion lanes |
