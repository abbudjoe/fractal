...
def _config_payload(request: Path1RunnerRequest, train_steps: int, eval_batches: int) -> dict[str, Any]:
    ...
    return {
        ...
        "head_loss_backend": request.manifest.runtime.head_loss_backend,
        "ffn_backend": request.manifest.runtime.ffn_backend,
        "mtp_aux_weight": request.manifest.runtime.mtp_aux_weight,
        "mtp_max_horizon": request.manifest.runtime.mtp_max_horizon,
