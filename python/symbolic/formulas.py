...
def default_symbolic_tasks(tasks_per_depth: int = 1) -> list[SymbolicTask]:
    candidates = [
        ...
        SymbolicTask(
            task_id="d1_log_shift",
            difficulty_depth=1,
            family="logarithm",
            expression=log(add(x(), c(2.4))),
            train_range=(-1.0, 1.0),
            validation_range=(-1.0, 1.0),
            extrapolation_range=(1.15, 2.05),
        ),
        SymbolicTask(
            task_id="d1_affine_negative",
            difficulty_depth=1,
            family="linear",
            expression=add(c(0.75), mul(c(-0.6), x())),
            train_range=(-1.0, 1.0),
            validation_range=(-1.0, 1.0),
            extrapolation_range=(1.15, 2.05),
        ),
        ...
        SymbolicTask(
            task_id="d2_exp_affine",
            difficulty_depth=2,
            family="exponential-affine",
            expression=exp(add(mul(c(0.22), x()), c(0.1))),
            train_range=(-1.0, 1.0),
            validation_range=(-1.0, 1.0),
            extrapolation_range=(1.15, 2.05),
        ),
        SymbolicTask(
            task_id="d2_log_affine",
            difficulty_depth=2,
            family="log-affine",
            expression=log(add(mul(c(0.55), x()), c(2.3))),
            train_range=(-1.0, 1.0),
            validation_range=(-1.0, 1.0),
            extrapolation_range=(1.15, 2.05),
        ),
        ...
        SymbolicTask(
            task_id="d3_exp_quadratic_soft",
            difficulty_depth=3,
            family="exp-polynomial",
            expression=exp(add(mul(c(0.08), mul(x(), x())), mul(c(-0.1), x()))),
            train_range=(-0.9, 1.0),
            validation_range=(-0.9, 1.0),
            extrapolation_range=(1.15, 2.05),
        ),
        SymbolicTask(
            task_id="d3_ratio_log",
            difficulty_depth=3,
            family="safe-ratio-log",
            expression=add(div(log(add(x(), c(2.2))), add(x(), c(2.8))), mul(c(0.1), x())),
            train_range=(-0.9, 1.0),
            validation_range=(-0.9, 1.0),
            extrapolation_range=(1.15, 2.05),
        ),
        ...
        SymbolicTask(
            task_id="d4_log_exp_ratio",
            difficulty_depth=4,
            family="composition-ratio",
            expression=div(log(add(exp(mul(c(0.25), x())), c(1.8))), add(x(), c(2.6))),
            train_range=(-0.9, 1.0),
            validation_range=(-0.9, 1.0),
            extrapolation_range=(1.15, 2.05),
        ),
        SymbolicTask(
            task_id="d4_product_ratio_log",
            difficulty_depth=4,
            family="composition-product-ratio",
            expression=mul(
                add(log(add(x(), c(2.5))), c(0.3)),
                div(add(x(), c(1.1)), add(mul(x(), x()), c(1.7))),
            ),
            train_range=(-0.9, 1.0),
            validation_range=(-0.9, 1.0),
            extrapolation_range=(1.15, 2.05),
